...
public class Vector2 {
	 ...
	 * calculates a dot product of this vector with other vector
	 ...
	 * @return dot product
	 */
	public static float dot(Vector2 a, Vector2 v){
		float sum = a.x * v.x;
		sum += a.y * v.y;
		return sum;
	}
	/**
	 * @author Dariusz Jerzewski
	 * add vectors and return a new vector
	 */
	public static Vector2 addVectors(final Vector2 a,final Vector2 b){
		return new Vector2(a.x + b.x, a.y + b.y);
	}

	/**
	 * @author Dariusz Jerzewski
	 * floor vector and return a new vector
	 */
