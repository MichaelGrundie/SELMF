package crazyhoneybadgerstudios.engine.io;
...
public class FileIO {
	 ...
	 *
	 * Loads a text file as an array of the files lines.
	 *
	 * @param txtFilePath
	 * @return
	 * @throws IOException
	 */
	public String[] loadTxtFile(String txtFilePath) throws IOException {

		InputStream inputStream = mAssetManager.open(txtFilePath);
		InputStreamReader inputStreamReader = new InputStreamReader(inputStream);

		/**
		 * Count how many lines of text there is.
		 */
		...
		/**
		 * Make an array to fit the number of lines.
		 */
		String[] txtFileArray = new String[count];
		...
		/**
		 * Make each line an element of the array.
		 */
		int pos = 0;
		while ((line = br.readLine()) != null) {
			txtFileArray[pos] = line;
			pos++;
		}
		br.close();
		inputStream.close();
