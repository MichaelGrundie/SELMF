...
public class CanvasRenderSurface extends View implements IRenderSurface {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see crazyhoneybadgerstudios.interfaces.IRenderSurface#getAsView()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * crazyhoneybadgerstudios.interfaces.IRenderSurface#render(uk.ac.qub.eeecs
	 * .gage.engine.ElapsedTime, crazyhoneybadgerstudios.engine.GameScreen)
	 */
	@Override
	...
	/**
	 * Gets the canvas that is being drawn to
	 * @return the canvas being drawn to
	 */
	public CanvasGraphics2D getIGraphics2d(){
